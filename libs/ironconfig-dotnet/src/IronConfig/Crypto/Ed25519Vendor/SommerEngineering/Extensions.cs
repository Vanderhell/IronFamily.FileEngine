...
namespace Ed25519Vendor.SommerEngineering
{
    ...
    {
        public static ReadOnlySpan<byte> ComputeHash(this ReadOnlySpan<byte> data)
        {
            using var sha512 = SHA512.Create();
            return sha512.ComputeHash(data.ToArray());
        }

        public static async Task<byte[]> ComputeHashAsync(this byte[] data)
        {
        ...
        public static ReadOnlySpan<byte> ComputeHash(this Stream inputStream)
        {
        ...
        public static async Task<byte[]> ComputeHashAsync(this Stream inputStream)
        {
            return await Task.Run(() =>
            {
                if(inputStream.CanSeek)
        ...
        public static BigInteger Mod(this BigInteger number, BigInteger modulo)
        {
        ...
        public static BigInteger Inv(this BigInteger number) => number.ExpMod(Constants.QM2, Constants.Q);

        public static BigInteger RecoverX(this BigInteger y)
        {
            var y2 = y * y;
        ...
        public static Span<byte> EncodeInt(this BigInteger number)
        {
        ...
        public static BigInteger DecodeInt(this ReadOnlySpan<byte> data) => new BigInteger(data) & Constants.U_N;

        public static BigInteger DecodeInt(this byte[] data) => new BigInteger(data) & Constants.U_N;

        public static BigInteger HashInt(this MemoryStream data)
        {
        ...
        public static async Task<BigInteger> HashIntAsync(this MemoryStream data)
        {
            data.Seek(0, SeekOrigin.Begin);
        ...
        public static int GetBit(this ReadOnlySpan<byte> data, int index) => data[index / 8] >> (index % 8) & 1;

        public static int GetBit(this byte[] data, int index) => data[index / 8] >> (index % 8) & 1;
