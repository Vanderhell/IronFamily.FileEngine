...
# CRC32 Parity Test: Compare C and .NET implementations on golden vectors

TEST_VECTORS_DIR="${1:-vectors/small/icfx}"
IRONCONFIGTOOL_EXE="tools/ironconfigtool/bin/Debug/net8.0/ironconfigtool.dll"
CRC_DIAGNOSTIC_EXE="libs/ironcfg-c/build/Release/crc_diagnostic.exe"

echo "CRC32 Parity Test: C vs .NET"
echo "====================================================="
